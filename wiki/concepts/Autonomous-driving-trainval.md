# Autonomous Driving Trainval

## Summary

Autonomous driving model training/evaluation tutorials, commonly involving dataset preparation, XPU containers, multi-card training, and evaluation scripts.
