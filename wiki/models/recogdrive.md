...
- [`recogdrive_trainval.md`](../../tutorials/recogdrive_trainval.md) — [`source summary`](../sources/recogdrive_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`recogdrive_trainval.md`](../../tutorials/recogdrive_trainval.md) | Autonomous Driving | Pretrain, Trainval | flash_attn | Not explicitly stated | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...) |
