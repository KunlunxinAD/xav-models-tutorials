...
- [`qwen3_llamafactory_trainval.md`](../../tutorials/qwen3_llamafactory_trainval.md) — [`source summary`](../sources/qwen3_llamafactory_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`qwen3_llamafactory_trainval.md`](../../tutorials/qwen3_llamafactory_trainval.md) | LLM/VLM/VLA | Trainval, SFT | Deepspeed, flash_attn, LlamaFactory, wandb | BF16 | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...) |
