...
- [`bevdet_trainval.md`](../../tutorials/bevdet_trainval.md) — [`source summary`](../sources/bevdet_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`bevdet_trainval.md`](../../tutorials/bevdet_trainval.md) | Autonomous Driving | Pretrain, Trainval | Not explicitly extracted | Not explicitly stated | Not explicitly extracted |
