...
- [`petrv2_trainval.md`](../../tutorials/petrv2_trainval.md) — [`source summary`](../sources/petrv2_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`petrv2_trainval.md`](../../tutorials/petrv2_trainval.md) | Autonomous Driving | Pretrain, Trainval | MMDetection3D | Not explicitly stated | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...) |
