...
- [`lanesegnet_trainval.md`](../../tutorials/lanesegnet_trainval.md) — [`source summary`](../sources/lanesegnet_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`lanesegnet_trainval.md`](../../tutorials/lanesegnet_trainval.md) | Autonomous Driving | Trainval | Not explicitly extracted | Not explicitly stated | Not explicitly extracted |
