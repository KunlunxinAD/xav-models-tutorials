...
- [`GameFormer-Planner_trainval.md`](../../tutorials/GameFormer-Planner_trainval.md) — [`source summary`](../sources/gameformer-planner_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`GameFormer-Planner_trainval.md`](../../tutorials/GameFormer-Planner_trainval.md) | Autonomous Driving | Trainval | Not explicitly extracted | Not explicitly stated | Not explicitly extracted |
