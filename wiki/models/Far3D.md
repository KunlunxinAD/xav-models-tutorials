...
- [`Far3D_trainval.md`](../../tutorials/Far3D_trainval.md) — [`source summary`](../sources/far3d_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`Far3D_trainval.md`](../../tutorials/Far3D_trainval.md) | Autonomous Driving | Trainval | Not explicitly extracted | Not explicitly stated | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...) |
