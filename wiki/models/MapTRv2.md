...
- [`maptrv2_trainval.md`](../../tutorials/maptrv2_trainval.md) — [`source summary`](../sources/maptrv2_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`maptrv2_trainval.md`](../../tutorials/maptrv2_trainval.md) | Autonomous Driving | Pretrain, Trainval | Not explicitly extracted | Not explicitly stated | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...) |
