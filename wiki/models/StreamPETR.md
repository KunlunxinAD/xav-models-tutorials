...
- [`StreamPETR_trainval.md`](../../tutorials/StreamPETR_trainval.md) — [`source summary`](../sources/streampetr_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`StreamPETR_trainval.md`](../../tutorials/StreamPETR_trainval.md) | Autonomous Driving | Pretrain, Trainval | flash_attn, MMCV, MMDetection3D | Not explicitly stated | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...) |
