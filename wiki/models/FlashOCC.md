...
- [`flashocc_trainval.md`](../../tutorials/flashocc_trainval.md) — [`source summary`](../sources/flashocc_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`flashocc_trainval.md`](../../tutorials/flashocc_trainval.md) | Autonomous Driving | Pretrain, Trainval | MMCV, MMDetection3D, wandb | Not explicitly stated | Not explicitly extracted |
