...
- [`QCNet_trainval.md`](../../tutorials/QCNet_trainval.md) — [`source summary`](../sources/qcnet_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`QCNet_trainval.md`](../../tutorials/QCNet_trainval.md) | Autonomous Driving | Trainval | Not explicitly extracted | Not explicitly stated | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...) |
