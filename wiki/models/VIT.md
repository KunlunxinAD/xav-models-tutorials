...
- [`VIT_trainval.md`](../../tutorials/VIT_trainval.md) — [`source summary`](../sources/vit_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`VIT_trainval.md`](../../tutorials/VIT_trainval.md) | Vision/OCR | Trainval | Not explicitly extracted | Not explicitly stated | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...) |
