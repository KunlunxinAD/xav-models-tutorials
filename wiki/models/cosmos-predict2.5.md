...
- [`cosmos_predict2.5_trainval.md`](../../tutorials/cosmos_predict2.5_trainval.md) — [`source summary`](../sources/cosmos_predict2.5_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`cosmos_predict2.5_trainval.md`](../../tutorials/cosmos_predict2.5_trainval.md) | World Model | Inference, Trainval | Megatron | FP16 | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...); CUDA_VISIBLE_DEVICES='0,1,2,3,4,5,6,7; CUDA_VISIBLE_DEVICES=7 |
