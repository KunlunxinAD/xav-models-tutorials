...
- [`multipathpp_trainval.md`](../../tutorials/multipathpp_trainval.md) — [`source summary`](../sources/multipathpp_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`multipathpp_trainval.md`](../../tutorials/multipathpp_trainval.md) | Autonomous Driving | Trainval | Not explicitly extracted | Not explicitly stated | Not explicitly extracted |
