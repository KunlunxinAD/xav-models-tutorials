...
- [`PETR_trainval.md`](../../tutorials/PETR_trainval.md) — [`source summary`](../sources/petr_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`PETR_trainval.md`](../../tutorials/PETR_trainval.md) | Autonomous Driving | Trainval | MMDetection3D | Not explicitly stated | Not explicitly extracted |
