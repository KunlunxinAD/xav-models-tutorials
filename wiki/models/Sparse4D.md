...
- [`sparse4d_trainval.md`](../../tutorials/sparse4d_trainval.md) — [`source summary`](../sources/sparse4d_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`sparse4d_trainval.md`](../../tutorials/sparse4d_trainval.md) | Autonomous Driving | Pretrain, Trainval | MMCV | Not explicitly stated | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...) |
