...
- [`xvllm_general_infer.md`](../../tutorials/xvllm_general_infer.md) — [`source summary`](../sources/xvllm_general_infer.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`xvllm_general_infer.md`](../../tutorials/xvllm_general_infer.md) | LLM/VLM/VLA | Inference | vLLM, xav-vLLM, xvLLM | Not explicitly stated | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...) |
