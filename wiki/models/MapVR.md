...
- [`mapvr_trainval.md`](../../tutorials/mapvr_trainval.md) — [`source summary`](../sources/mapvr_trainval.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`mapvr_trainval.md`](../../tutorials/mapvr_trainval.md) | Autonomous Driving | Pretrain, Trainval | Not explicitly extracted | Not explicitly stated | 8 XPU device entries (/dev/xpu0, /dev/xpu1, /dev/xpu2...) |
