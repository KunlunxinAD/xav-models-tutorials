...
- [`LLaMA_infer.md`](../../tutorials/LLaMA_infer.md) — [`source summary`](../sources/llama_infer.md)

## Source-backed support matrix

| Tutorial | Domain | Workflow | Frameworks / backends | Precision mentions | Device hints |
| --- | --- | --- | --- | --- | --- |
| [`LLaMA_infer.md`](../../tutorials/LLaMA_infer.md) | LLM/VLM/VLA | Inference | TensorRT, vLLM | BF16, FP16 | Not explicitly extracted |
