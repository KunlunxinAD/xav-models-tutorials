...
- [`LLaVA_trainval.md`](../../tutorials/LLaVA_trainval.md)
...
| Model / topic | LLaVA |
| Domain | LLM/VLM/VLA |
| Workflow tags | Inference, Pretrain, Trainval, SFT |
...
- <https://klx-sdk-release-public.su.bcebos.com/v1/xav/release/models/LLaVA/xpytorch-cp310-torch251-ubuntu2004-x64.run>
...
- <https://klx-sdk-release-public.su.bcebos.com/v1/xav/data/LLaVA-SFT/LLaVA-Instruct-150K.tar.gz>
- <https://klx-sdk-release-public.su.bcebos.com/v1/xav/data/LLaVA-SFT/coco/COCO2017.tar.gz>
- <https://klx-sdk-release-public.su.bcebos.com/v1/xav/data/LLaVA-SFT/gqa/images.zip>
- <https://klx-sdk-release-public.su.bcebos.com/v1/xav/data/LLaVA-SFT/ocr_vqa/ocr_vqa.tar>
